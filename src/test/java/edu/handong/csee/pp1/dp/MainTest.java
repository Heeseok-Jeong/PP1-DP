...
public class MainTest {
	...
	public void testMain() {
		...
		//String[] args = {"C:\\Users\\jaech\\git\\PP1-DP","data/PP1-DP.arff"};
		 String[] args = {"/Users/heeseok/Downloads/PP1-DP", "data/PP1-DP.arff"}; // for mac users
	...
	public void testForTasks2() {
		...
		String[] args1 = {"/Users/heeseok/Downloads/code2java", "data/code2java.arff"}; // for mac users
		
		assertEquals(args1.length,2);
		
		Main.main(args1);
		
		String[] args2 = {"/Users/heeseok/Downloads/java", "data/java.arff"}; // for mac users
